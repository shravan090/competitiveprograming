...
def find_rectangular_overlap(rect1, rect2):
    ...
    rect1_right_x=min(rect1['left_x']+rect1['width'],rect2['left_x']+rect2['width'])
    rect1_top_y=min(rect1['bottom_y']+rect1['height'],rect2['bottom_y']+rect2['height'])
    if rect1_right_x>rect2['left_x'] and rect1_top_y> rect2['bottom_y']:
        return {'left_x': rect2['left_x'],'bottom_y': rect2['bottom_y'],'width':
            rect1_right_x-rect2['left_x'],'height': rect1_top_y-rect2['bottom_y']}
    else:
